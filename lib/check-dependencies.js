...
module.exports = function checkDependencies(config, callback) {
    ...
    var mappings, depsJson, depsJsonName, depsJsonRegex, depsDirName, pkgManagerPath,
    ...
    if (options.type === 'bower') {
        // Allow both local & global bower.
        pkgManagerPath = findup('node_modules/bower/bin/bower') || 'bower';
    } else {
        pkgManagerPath = 'npm';
    }
    ...
    spawn(win32 ? 'cmd' : pkgManagerPath,
        win32 ? ['/c', pkgManagerPath, 'install'] : ['install'],
        {
