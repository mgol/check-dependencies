...
const checkDependenciesHelper = (syncOrAsync, config, callback) => {
    ...
    const packageJsonName = options.packageManager === 'bower' ? 'bower.json' : 'package.json';
    const packageJsonRegex = options.packageManager === 'bower' ? /bower\.json$/ : /package\.json$/;
    depsDirName = options.packageManager === 'bower' ? 'bower_components' : 'node_modules';
    ...
    const depsJsonName = options.packageManager === 'bower' ? '.bower.json' : 'package.json';
