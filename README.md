...
[![Travis build Status](https://travis-ci.org/mgol/check-dependencies.svg?branch=master)](https://travis-ci.org/mgol/check-dependencies)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/mmlmha7ntge8j9hp/branch/master?svg=true)](https://ci.appveyor.com/project/mgol/check-dependencies/branch/master)
